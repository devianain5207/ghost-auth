...
<div
  class="fixed inset-0 z-50 settings-backdrop {mounted ? 'open' : ''}"
  onclick={close}
...
>
  ...
  >
    ...
    <!-- Content -->
    <div class="w-full px-5 py-4 flex flex-col flex-1 overflow-y-auto" style="padding-bottom: 5rem;">
      <!-- Language list -->
    ...
    <div class="fixed inset-x-5 z-20 flex items-center search-bottom">
      <input
        type="text"
        bind:value={search}
